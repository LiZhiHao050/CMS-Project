...
<div class="avatar">
	<img alt="" src="/resource/images/default_avatar.png" class="img-thumbnail">
</div>
<br />
<div>
	<div class="list-group">
		<ul class="list-group">
			<li class="list-group-item  text-center"><a class="channel"
				href="javascript:void(0)"  data="/user/myArticles">我的文章
			</a></li>
			<li class="list-group-item  text-center"><a class="channel"
			...
			<li class="list-group-item  text-center"><a class="channel"
				href="javascript:void(0)" class="list-group-item" data="/user/optionUser">个人设置</a></li>
				<li class="list-group-item  text-center"><a class="channel"
